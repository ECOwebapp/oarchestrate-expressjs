...
export const tempSupabaseClient = (token) => {
  return createClient(supabaseUrl, supabaseAnonKey, {
    global: {
      headers: {
        Authorization: `Bearer ${token}`, // This must be exactly like this
      },
    },
    auth: {
      persistSession: false, // Prevents the client from trying to use non-existent storage
